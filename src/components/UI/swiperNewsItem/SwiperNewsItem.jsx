...
import './SwiperNewsItem.scss'
function SwiperNewsItem(props) {
  return (
    <div className="swiper_news_item">
      <div className="swiper_news_item_inner">
        <div className="swiper_news_item_img">
          <svg
            version="1.1"
        ...
        <div className="swiper_news_item_title">
          <h1>{props.title}</h1>
          <span>12 мая 2022</span>
        </div>
        <div className="swiper_news_item_words">
          <p>
            {props.text}
          </p>
        </div>
        <div className="swiper_news_item_btn">
